...
var ARoute = require("./route");

var ALayer = require("./layer");
...
var proto = module.exports = function (options) {
  ...
  setPrototypeOf(router, proto); // TODO: this line is workaround, please it can work?
...
function mergeParams(params, parent) {
  if ((0, _typeof2["default"])(parent) !== 'object' || !parent) {
    return params;
